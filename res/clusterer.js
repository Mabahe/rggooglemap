...
Clusterer.defaultIcon.iconSize = new google.maps.Size( 30, 51 );
Clusterer.defaultIcon.shadowSize = new google.maps.Size( 56, 51 );
Clusterer.defaultIcon.iconAnchor = new google.maps.Point( 13, 34 );
Clusterer.defaultIcon.infoWindowAnchor = new google.maps.Point( 13, 3 );
Clusterer.defaultIcon.infoShadowAnchor = new google.maps.Point( 27, 37 );
...
Clusterer.PopUp = function ( cluster )
	...
	if ( marker != null )
		...
		html += '<img src="' + marker.getIcon().smallImage + '">';
		  ...
		  html += '<img src="' + marker.getIcon().image +  '">';
