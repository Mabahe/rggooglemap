...
class tx_rggm_fe extends tslib_pibase {
    ...
    #####################
      ...
      // delete a entry
      $postvars = t3lib_div::GPvar('delete');       
  ...
  function singleMap($key) {
      ...
      // making the query
      $postvars = $this->postvars = t3lib_div::GPvar($this->realConf->conf['rggm.']['detailUidParam']);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rggooglemap/class.tx_rggm_fe.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rggooglemap/class.tx_rggm_fe.php']);
}
